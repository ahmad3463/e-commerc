    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mt-md-5">
          ...
          <p class="footer-para">Any questions? Let us know in store at 8th floor, 379 Hudson St, New York, NY 10018 or
            call us on (+1) 96 716 6879</p>
          <div class="footer-svg">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter-x "
              viewBox="0 0 16 16" style="margin: 0px 1px;">
              <path
